...
{
    public class IncotermWriteRepository : WriteRepository<Incoterm>, IIncotermWriteRepository
    {
        public IncotermWriteRepository(AppDbContext context) : base(context)
        {
        }
    }
}
